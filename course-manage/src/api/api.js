...
//重置密码接口
export const requestRePassword = params => { 
	return axios.post(
		`${base}/login/repassword`,
		Qs.stringify(params),
		{
	        headers: {
	          'Content-Type': 'application/x-www-form-urlencoded'
...
//获取主观题学生作答记录
export const getExperimentResult = params => { 
    return axios.post(
        `${base}/Exconclusion/queryResult`,
        Qs.stringify(params),
        {
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded'
...
// 保存实验报告客观题学生作答结果
export const saveObjectiveQuestionResult = params => { 
    return axios.post(
        `${base}/ExObjectiveQuestion/saveResult`,
        Qs.stringify(params),
        {
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded'
